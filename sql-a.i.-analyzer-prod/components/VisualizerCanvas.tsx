...
const OperationNodeComponent: React.FC<NodeProps> = ({ node, style, isSelected, onMouseDown, onDelete }) => {
...
const ConnectionLine: React.FC<{ 
  ...
  selected?: boolean; 
}> = ({ edge, start, end, onClick, selected }) => {
...
export const VisualizerCanvas: React.FC<VisualizerCanvasProps> = ({ visualFlow, isLoading, onFlowChange, mockDb }) => {

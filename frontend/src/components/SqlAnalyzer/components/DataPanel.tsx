...
import { ChevronRight, ChevronLeft, Table as TableIcon } from 'lucide-react';

interface DataPanelProps {
    plan: ExecutionStep[];
}

export const DataPanel: React.FC<DataPanelProps> = ({ plan }) => {
    ...
    return (
        <div className="h-64 bg-slate-900 border-t border-slate-700 flex flex-col shrink-0">
            <div className="h-10 border-b border-slate-700 px-4 flex items-center justify-between bg-slate-800/50 shrink-0">
                ...
                <div className="flex items-center gap-2 bg-slate-900/50 p-1 rounded-lg border border-slate-700/50">
                    ...
                    <span className="text-xs font-mono text-slate-400 min-w-[80px] text-center select-none">

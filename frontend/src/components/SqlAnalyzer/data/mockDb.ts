...
export const mockDb: MockDatabase = {
  ...
  orders: {
    ...
    schema: [
      ...
      { name: 'store_id', type: 'INT', isForeignKey: true },
      { name: 'coupon_code', type: 'VARCHAR' },
      { name: 'total_amount', type: 'DECIMAL' },
      { name: 'status', type: 'VARCHAR' },
    ],
    data: [
      { id: 5001, user_id: 1, product_id: 101, store_id: 1, coupon_code: 'SAVE10', total_amount: 1080, status: 'completed' },
      { id: 5002, user_id: 1, product_id: 102, store_id: 1, coupon_code: null, total_amount: 25, status: 'completed' },
      { id: 5003, user_id: 2, product_id: 103, store_id: 2, coupon_code: null, total_amount: 15, status: 'pending' },
      { id: 5004, user_id: 4, product_id: 104, store_id: 1, coupon_code: 'WELCOME20', total_amount: 240, status: 'shipped' },
    ]
  },
  stores: {
    name: 'stores',
